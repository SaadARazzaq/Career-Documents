...
\begin{center}
    ...
    {\underline{The Applied Engineer SubStack}}
\end{center}
...
\begin{itemize}
    ...
    \item Maintained translation quality within 1.2\% BLEU score of the original FP32 model, analyzing layer sensitivity \& calibration strategies for preserving quality under aggressive compression.
\end{itemize}
...
\begin{itemize}
    ...
    \item Achieved convergence within 200--500 episodes, demonstrated stable learning via replay buffer \& target network updates.
\end{itemize}
...
\hfill
\textit{FAST--NUCES}
\begin{itemize} \item Collected and prepared real-world clinical data from local hospitals and developed a machine learning pipeline using XGBoost for data-driven clinical prediction. \item Applied feature engineering and model evaluation to transform real-world patient data into predictive insights for clinical decision support. \end{itemize}
...
\begin{itemize}
    \item Developed and maintained full-stack applications across frontend, backend, and database layers, implementing authentication, API integrations, and database-driven workflows for production systems.
\end{itemize}
...
CNNs, RNNs, LSTMs, DQN, VGG, FaceNet, Vision Transformers (ViT), Seq2Seq, ResNet
...
\begin{itemize}
    ...
    \hfill
\href{https://www.coursera.org/account/accomplishments/professional-cert/AUXO12A3KUE7}{\underline{Verify}}
    \item IBM -- Generative AI Engineering Professional Certificate, 2025
    \hfill
\href{https://www.coursera.org/account/accomplishments/professional-cert/55VL0VUWMJYK}{\underline{Verify}}
    \item Google -- Advanced Data Analytics Professional Certificate, 2025
    \hfill
\href{https://www.coursera.org/account/accomplishments/professional-cert/RS5PNGTXG6GM}{\underline{Verify}}
\end{itemize}
...
\hfill
\href{https://theappliedengineer.substack.com/}{\underline{Substack}}

\begin{itemize}
    \item Authoring technical articles that explain the mathematical foundations of machine learning, including loss functions, gradients, backpropagation, and training dynamics, for readers without prior ML background.
    \item Developing intuitive, example-driven explanations that connect mathematical concepts to practical machine learning workflows and model behavior.
    \item Translating concepts from optimization, neural network training, and model internals into accessible technical content while maintaining mathematical rigor.
\end{itemize}
